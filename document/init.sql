...
INSERT INTO `ums_admin` VALUES ('1', 'admin', '{MD5}e10adc3949ba59abbe56e057f20f883e', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20190129/170157_yIl3_1767531.jpg', 'admin@163.com', '系统管理员', '系统管理员', now(), now(), '1');
...
INSERT INTO `ums_permission` VALUES ('1', '0', '测试', null, null, '0', null, '1', now(), '1');
INSERT INTO `ums_permission` VALUES ('2', '1', '测试权限列表', 'test:auth:query', null, '1', '/test/auth/query', '1', now(), '1');
INSERT INTO `ums_permission` VALUES ('3', '2', '测试权限：新增', 'test:auth:insert', null, '2', '/test/auth/insert', '1', now(), '1');
INSERT INTO `ums_permission` VALUES ('4', '2', '测试权限：修改', 'test:auth:update', null, '2', '/test/auth/update', '1', now(), '2');
INSERT INTO `ums_permission` VALUES ('5', '2', '测试权限：删除', 'test:auth:delete', null, '2', '/test/auth/delete', '1', now(), '3');
...
INSERT INTO `ums_role` VALUES ('1', '管理员', '管理员', '1', now(), '1', '0');
